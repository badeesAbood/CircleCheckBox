...
///
/// To show the [CircleCheckboxListTile] as disabled, pass null as the [onChanged]
/// callback.
///
...
/// {@end-tool}
///
/// ## CircleCheckboxListTile isn't exactly what I want
///
...
class CircleCheckboxListTile extends StatelessWidget {
  ...
  /// widgets in [CircleCheckboxListTile].
  ///
  ...
  /// If non-null, defines the background color when [CircleCheckboxListTile.selected] is true.
  ...
  @override
  Widget build(BuildContext context) {
    final Widget control = CircleCheckbox(
      value: value,
      onChanged: onChanged,
